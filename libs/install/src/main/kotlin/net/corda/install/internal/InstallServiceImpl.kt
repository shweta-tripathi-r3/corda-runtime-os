...
internal class InstallServiceImpl @Activate constructor(
    ...
    override fun loadCpk(cpkHash : SecureHash, inputStream: InputStream) = cordaPackagePersistence.get(cpkHash) ?: cordaPackagePersistence.putCpk(inputStream)

    override fun getCpb(cpbIdentifier: Cpb.Identifier) = cordaPackagePersistence.get(cpbIdentifier)
    ...
    override fun verifyCpkGroup(cpks: Iterable<Cpk>) = groupVerifiers.forEach { verifier -> verifier.verify(cpks) }
