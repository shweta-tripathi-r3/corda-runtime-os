...
@InitiatingFlow(protocol = "random2")
class ProxyFlow2 : ClientStartableFlow {
...
class DynamicInvocationHandler2 : InvocationHandler {
...
interface SampleFacade2 {
    fun hello(alias: MemberX500Name, facadeName: String, methodName: String, payload: String) : SubFlow<MemberX500Name>
}